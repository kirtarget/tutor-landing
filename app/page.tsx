...
const IconGraduation = () => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12 14v9M4.239 9.5a12.021 12.021 0 003.666 4.5M19.761 9.5a12.021 12.021 0 01-3.666 4.5"
    />
  </svg>
);
...
export default function Home() {
  const openQuiz = () => {
    window.location.href = "/quiz/request";
  };
  ...
  return (
    <div className="min-h-screen text-slate-900 bg-white relative">
      ...
      <main id="top" className="relative z-10">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1.5 text-xs leading-relaxed text-slate-600">
                      2 минуты на ответы — и вы получаете список из 8–12
                      подходящих преподавателей с ценами и свободными слотами.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex gap-4 md:grid md:grid-cols-3 md:gap-6 min-w-max md:min-w-0">
                  {[
                    ...
                    >
                      ...
                      <p className="mt-1.5 md:mt-2 text-xs md:text-sm leading-relaxed text-slate-600 line-clamp-3 md:line-clamp-none">
                        {step.text}
                      </p>
                    </div>
                  ))}
              ...
              <div className="overflow-x-auto px-4 md:px-0 pb-2 md:pb-0">
                <div className="flex gap-4 md:grid md:grid-cols-2 md:gap-6 min-w-max md:min-w-0">
                  {[
                    ...
                    >
                      <div
                        className={`mb-2 md:mb-4 flex h-10 w-10 md:h-14 md:w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${item.color} text-white shadow-md transition-transform group-hover:scale-110 shrink-0`}
                      >
                        {item.icon === "👤" && <IconUser />}
                        {item.icon === "📚" && <IconBook />}
                        {item.icon === "📅" && <IconCalendar />}
                      ...
                      <h3 className="text-sm md:text-lg font-bold text-slate-900 line-clamp-2">
                        {item.title}
                      </h3>
                      <p className="mt-1.5 md:mt-2 text-xs md:text-sm leading-relaxed text-slate-600 line-clamp-3 md:line-clamp-none">
                        {item.text}
            ...
            <div className="rounded-3xl bg-white p-5 md:p-8 shadow-soft border border-blue-100/50">
              ...
              <ul className="mt-4 md:mt-6 space-y-2 md:space-y-3 text-sm md:text-base text-slate-700">
                <li className="flex items-start gap-2 md:gap-3">
                  <svg
                    className="h-5 w-5 md:h-6 md:w-6 shrink-0 text-sky-500 mt-0.5"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <div className="flex gap-4 md:grid md:grid-cols-2 md:gap-6 min-w-max md:min-w-0">
                  {[
                    ...
                    >
                      ...
                      <div
                        className={`mb-2 md:mb-4 flex h-10 w-10 md:h-14 md:w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${item.color} text-white shadow-md transition-transform group-hover:scale-110 relative z-10 mx-auto md:mx-0 shrink-0`}
                      >
                        {item.icon === "🎒" && <IconBackpack />}
                        {item.icon === "📝" && <IconDocument />}
                        {item.icon === "🎓" && <IconGraduation />}
                      ...
                      <span
                        className={`inline-block mb-1.5 md:mb-2 px-2.5 md:px-3 py-0.5 md:py-1 rounded-full text-xs font-semibold bg-gradient-to-r ${item.color} text-white w-fit relative z-10 mx-auto md:mx-0`}
                      >
                        {item.badge}
                      </span>
                      <h3 className="text-sm md:text-lg font-bold text-slate-900 relative z-10 text-center md:text-left line-clamp-2">
                        {item.title}
                      </h3>
                      <p className="mt-1.5 md:mt-2 text-xs md:text-sm leading-relaxed text-slate-600 relative z-10 text-center md:text-left line-clamp-3 md:line-clamp-none">
                        {item.text}
                      </p>
                    </div>
                  ))}
          ...
          <div className="mx-auto max-w-6xl px-4">
            ...
            <div className="mt-6 md:mt-10 grid gap-6 md:gap-8 md:grid-cols-2">
              ...
              <ul className="space-y-3 md:space-y-4 text-sm md:text-base text-slate-700">
                <li className="flex items-start gap-2 md:gap-3">
                  <svg
                    className="h-5 w-5 md:h-6 md:w-6 shrink-0 text-emerald-500 mt-0.5"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                  ...
                  <span>
                    Экономия времени — подбор занимает несколько минут.
                  </span>
                </li>
                <li className="flex items-start gap-2 md:gap-3">
                  <svg
              ...
              <ul className="space-y-3 md:space-y-4 text-sm md:text-base text-slate-700">
                ...
                <li className="flex items-start gap-2 md:gap-3">
                  ...
                  <span>
                    Замена преподавателя без потерь по будущим урокам.
                  </span>
                </li>
                <li className="flex items-start gap-2 md:gap-3">
                  <svg
                ...
                <div className="flex gap-4 md:grid md:grid-cols-3 md:gap-6 min-w-max md:min-w-0">
                  ...
                  <div className="flex flex-col rounded-3xl bg-white p-4 md:p-6 shadow-soft transition-all hover:shadow-medium hover:-translate-y-1 border border-blue-100/50 min-w-[280px] max-w-[280px] md:min-w-0 md:max-w-none aspect-square md:aspect-auto">
                    ...
                    <p className="mt-1.5 md:mt-2 text-xs md:text-sm leading-relaxed text-slate-600 line-clamp-4 md:line-clamp-none">
                      ...
                      Стало: 27–29 баллов на пробниках после занятий с
                      репетитором по русскому.
                    </p>
                  </div>
                  {/* 3 */}
                ...
                <div className="flex gap-4 md:grid md:grid-cols-3 md:gap-6 min-w-max md:min-w-0">
                  {[
                    ...
                    >
                      ...
                      <h3 className="text-sm md:text-base font-bold text-slate-900 text-center md:text-left line-clamp-2">
                        {tutor.name}
                      </h3>
                      <p className="mt-1.5 md:mt-2 text-xs md:text-sm leading-relaxed text-slate-600 text-center md:text-left line-clamp-3 md:line-clamp-none">
                        {tutor.meta}
                      </p>
                    </div>
                  ))}
        ...
        <section
          id="safety"
          className="py-12 md:py-24 bg-gradient-to-b from-white via-sky-50/30 to-sky-100/50"
        >
          <div className="mx-auto max-w-6xl px-4">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-2xl font-extrabold text-slate-900 md:text-4xl">
            ...
            <div className="mt-6 md:mt-10 grid gap-6 md:grid-cols-3">
              {[
                ...
                >
                  <div
                    className={`mb-3 md:mb-4 flex h-12 w-12 md:h-14 md:w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${item.color} text-white shadow-md transition-transform group-hover:scale-110 mx-auto md:mx-0`}
                  >
                    {item.icon === "✅" && <IconCheck />}
                    {item.icon === "🔒" && <IconLock />}
                    {item.icon === "📚" && <IconBook />}
                  ...
                  <h3 className="text-base md:text-lg font-bold text-slate-900 text-center md:text-left">
                    {item.title}
                  </h3>
                  <p className="mt-2 text-sm leading-relaxed text-slate-600 text-center md:text-left">
                    {item.text}
                  </p>
                </div>
              ))}
        ...
        {/* ДЛЯ РЕПЕТИТОРОВ */}
        <section id="for-tutors" className="border-t border-slate-200 py-8">
          <div className="mx-auto flex max-w-6xl flex-col items-start gap-4 px-4 md:flex-row md:items-center md:justify-between">
            <p className="text-base font-medium text-slate-700">
              Вы репетитор и хотите вести учеников 5–11 классов по школьным
              предметам и подготовке к ОГЭ и ЕГЭ через платформу?
            </p>
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-sky-100/50 via-sky-200/60 to-sky-400 py-12 md:py-24">
          ...
          <div className="mx-auto max-w-4xl px-4 text-center relative z-10">
            ...
            <p className="mx-auto mt-3 md:mt-4 max-w-2xl text-base md:text-lg text-slate-700">
              Ответьте на 5–7 вопросов — мы подберём 8–12 подходящих репетиторов
              по нужным предметам. Пробный урок уже на этой неделе.
            </p>
            <button
              onClick={openQuiz}
